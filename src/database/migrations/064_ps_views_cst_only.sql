-- Fix vw_ps_project_status and vw_ps_projects_at_risk to only include CST board projects.
-- PROJ board issues should not appear in the PS Delivery tab.

-- vw_ps_project_status: add jira_project_key = 'CST' to the base table filter
...
-- vw_ps_projects_at_risk: add jira_project_key = 'CST' filter (inherits from vw_ps_project_status but be explicit)
