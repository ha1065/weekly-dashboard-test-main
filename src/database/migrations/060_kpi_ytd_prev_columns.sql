-- Migration 060: Add _prev (prior week) columns to vw_kpi_ytd
-- These are used by QuickSight KPI tiles as TargetValues for WoW comparison.
-- Each _prev column = LAG(current_column) OVER (ORDER BY week_start_date)
