...
OWNER_ARN = (
    'arn:aws:quicksight:us-east-1:961341524729:user/default/'
    'AWSReservedSSO_AWSAdministratorAccess_ed420cc098d02bac/chris.xenos'
)
OWNER_ARN2 = 'arn:aws:quicksight:us-east-1:961341524729:user/default/chris.xenos@cloudelligent.com'
...
ANALYSIS_PERMISSIONS = [{'Principal': p, 'Actions': [
...
]} for p in [OWNER_ARN, OWNER_ARN2]]

DASHBOARD_PERMISSIONS = [{'Principal': p, 'Actions': [
...
def build_sheet1():
    ...
    layout_items = [
        ...
        gi('chart-s1-util-trend',     0, 10, 18, 12),
        gi('chart-s1-ontime-trend',  18, 10, 18, 12),
        gi('bar-s1-health',           0, 22, 36, 10),
    ]
    ...
    return sheet, [fg_date, fg_complete]
...
def build_sheet2():
    ...
    return sheet, [fg_lob, fg_practice, fg_date, fg_complete]
...
def build_sheet3():
    ...
    return sheet, [fg_lob, fg_practice, fg_pod, fg_staff, fg_date, fg_complete]
